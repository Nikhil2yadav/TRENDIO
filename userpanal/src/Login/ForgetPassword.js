  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://127.0.0.1:8080/college%20project/mini%20project/api/CheckEmailBuyer.php",
        formData
      );
...
// console.log(password)
      const response = await axios.post(
        "http://127.0.0.1:8080/college%20project/mini%20project/api/ResetPasswordBuyer.php",
        formData
      );
