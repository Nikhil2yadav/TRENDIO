...
const AddProduct = () => {
  ...
  const fetchProductSize = async () => {
    try {
      const response = await axios.get("http://localhost:8000/api/getProductSize.php");
  ...
  const fetchProductTypes = async () => {
    const response = await axios.get('http://localhost:8000/api/getProductType.php');
  ...
  const fetchProductData = async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/GetsingleProductforupdateapi.php?ProductId=${id}`
      );
  ...
  const addProduct = async () => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8000/api/ProductApi.php',
        formData,
  ...
  const updateProduct = async () => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8000/api/UpdatePrdouctapi.php',
        formData,
        { headers: { 'Content-Type': 'multipart/form-data' } }
      );
