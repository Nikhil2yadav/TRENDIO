...
const ContactAdmin = () => {
  ...
  const fetchMessages = async () => {
    const response = await axios.get(`http://localhost:8000/api/FetchMessages.php?sellerId=${sellerId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post('http://localhost:8000/api/ContactAdmin.php', {
      sellerId: sellerId,
      message: message,
