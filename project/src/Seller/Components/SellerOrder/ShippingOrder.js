...
const ShippingOrder = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const response = await axios.post(
          'http://localhost:8000/api/GetshippingOrderaccordingtoseller.php',
          { SellerId },
          { headers: { 'Content-Type': 'application/x-www-form-urlencoded' }}
        );
        // console.log(response.data)
  ...
  const handleViewOrder = (orderDetailId) => {
    navigate(`/seller/ShippedOrder/${orderDetailId}`);
  };
    ...
    <div className='content-wrapper'>
      <div className="content-header">
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              <h1 className="m-0 text-dark">Shipping Orders</h1>
            </div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                <li className="breadcrumb-item">
                ...
                <li className="breadcrumb-item active">Shipping Orders</li>
              </ol>
            </div>
          </div>
        </div>
